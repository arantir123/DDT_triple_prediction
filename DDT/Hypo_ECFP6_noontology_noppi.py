...
# for hyperbolic based variants using ECFP6 + self-contained target embedding look-up table
...
def run_model_predict_DDT(args):
    ...
    model = HyboNetnoEncoder(abs2_rel_list, args.dim, args.max_scale, args.max_norm, args.margin, all_drug_morgan, args.bias)
    ...
    file = './outputs/' + 'Hypo_ECFP6_noontology_noppi_log_%d.%s.txt' % (args.dim, args.data)
...
if __name__=='__main__':
    ...
    # number of negative samples in the KGC training
    args.nneg = 50
    ...
    args.max_scale = 2.5
    args.real_neg = True
    args.bias = True # the bias for the Lorentz fully linear encoder
