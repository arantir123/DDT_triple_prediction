...
from models.base_models_ import HyboNet4KG_
...
# for hyperbolic based variants using self-contained drug embedding look-up table + GO/PPI graph
...
def run_model_predict_DDT(args):
    ...
    hyponet4kg = HyboNet4KG_(target_features_list, processed_adj, abs2_rel_list, args, args.dim, args.max_scale, args.max_norm, args.margin)
    ...
    file = './outputs/' + 'Hypo_noECFP6_ontology_ppi_log_%d.%s.txt' % (args.dim, args.data)
