...
# for Euclidean based variants without using domain knowledge
...
def run_model_predict_DDT(args):
    ...
    euclinet4kg = EucliNet4KG(abs2_rel_list, args, args.dim, args.margin, args.extra_bias)
    ...
    file = './outputs/' + 'Eucli_noECFP6_noseqsimilarity_log_%d.%s.txt' % (args.dim, args.data)
